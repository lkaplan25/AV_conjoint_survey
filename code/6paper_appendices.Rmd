...
results_mxl_weighted <- make_coef_table(mxl_wtp)
...
results_mnl <- make_coef_table(mnl_wtp)
results_mnl_weighted <- make_coef_table(mnl_wtp_weighted)
...
modelResults_mnl <- round(summary(mnl_wtp)$statTable, 1)
modelResults_mnl_weighted <- round(summary(mnl_wtp_weighted)$statTable, 1)
